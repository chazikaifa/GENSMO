...
$arr = [
	["name" => "last3_text","data" => '9月18日-25日',"dataType" => 'string'],
	["name" => "last2_text","data" => '10月1日-16日',"dataType" => 'string'],
	["name" => "last_text","data" => '10月16日-23日',"dataType" => 'string'],
	// ["name" => "last3_text","data" => '6月',"dataType" => 'string'],
	// ["name" => "last2_text","data" => '7月',"dataType" => 'string'],
	// ["name" => "last_text","data" => '8月',"dataType" => 'string'],
	["name" => "assess_data_last3","data" => '243',"dataType" => 'number'],
	["name" => "assess_data_last2","data" => '346',"dataType" => 'number'],
	["name" => "assess_data_last","data" => '149',"dataType" => 'number'],
	["name" => "local_data_last3","data" => '66',"dataType" => 'number'],
	["name" => "local_data_last2","data" => '83',"dataType" => 'number'],
	["name" => "local_data_last","data" => '70',"dataType" => 'number'],
